package cn.hzq.openai.data.domain.weixin.service.message;

import cn.hzq.openai.data.domain.weixin.model.entity.MessageTextEntity;
import cn.hzq.openai.data.domain.weixin.model.entity.UserBehaviorMessageEntity;
import cn.hzq.openai.data.domain.weixin.model.valobj.MsgTypeVO;
import cn.hzq.openai.data.domain.weixin.service.IWeiXinBehaviorService;
import cn.hzq.openai.data.types.exception.ChatGMLException;
import cn.hzq.openai.data.types.sdk.weixin.XmlUtil;
...
public class WeiXinBehaviorService implements IWeiXinBehaviorService {
    ...
    public String acceptUserBehavior(UserBehaviorMessageEntity userBehaviorMessageEntity) {
        ...
        throw new ChatGMLException(userBehaviorMessageEntity.getMsgType() + " 未被处理的行为类型 Err！");
    }
